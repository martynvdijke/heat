...
func (_u *AdminUserUpdate) SetPassword(v string) *AdminUserUpdate {
	_u.mutation.SetPassword(v)
	return _u
}

// SetNillablePassword sets the "password" field if the given value is not nil.
func (_u *AdminUserUpdate) SetNillablePassword(v *string) *AdminUserUpdate {
	if v != nil {
		_u.SetPassword(*v)
	}
	return _u
...
// SetPassword sets the "password" field.
func (_u *AdminUserUpdateOne) SetPassword(v string) *AdminUserUpdateOne {
	_u.mutation.SetPassword(v)
	return _u
}

// SetNillablePassword sets the "password" field if the given value is not nil.
func (_u *AdminUserUpdateOne) SetNillablePassword(v *string) *AdminUserUpdateOne {
	if v != nil {
		_u.SetPassword(*v)
	}
	return _u
