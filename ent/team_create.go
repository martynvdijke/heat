...
func (_c *TeamCreate) SetColor(v string) *TeamCreate {
	_c.mutation.SetColor(v)
	return _c
}

// SetNillableColor sets the "color" field if the given value is not nil.
func (_c *TeamCreate) SetNillableColor(v *string) *TeamCreate {
	if v != nil {
		_c.SetColor(*v)
	}
	return _c
...
func (_c *TeamCreate) SetID(v int) *TeamCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *TeamCreate) check() error {
	...
	if _, ok := _c.mutation.Color(); !ok {
		return &ValidationError{Name: "color", err: errors.New(`ent: missing required field "Team.color"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
