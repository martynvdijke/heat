...
func (_q *TrackQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *TrackQuery) FirstIDX(ctx context.Context) string {
...
func (_q *TrackQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *TrackQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *TrackQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *TrackQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
