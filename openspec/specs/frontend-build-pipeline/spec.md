# frontend-build-pipeline Specification

## Purpose
Define the frontend build pipeline including TypeScript bundling per page, minification for production, sourcemaps for development, and Taskfile commands.
