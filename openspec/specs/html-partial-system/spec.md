# html-partial-system Specification

## Purpose
Provide a shared HTML base template system with Go html/template inheritance, eliminating markup duplication across all pages.
