# inline-js-elimination Specification

## Purpose
Eliminate all inline JavaScript from HTML pages by moving logic to TypeScript modules with addEventListener-based event handling and consistent error handling.
